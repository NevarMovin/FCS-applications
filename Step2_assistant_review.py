...
file = 'CsiNet_' + envir + '_dim' + str(encoded_dim) + 'Step2'
...
encoder.load_weights('result/CsiNet_encoder_indoor_dim512_Step1_1_model.h5')
encoder_temp.load_weights('result/CsiNet_encoder_outdoor_dim512_Step1_12_model.h5')
...
decoder.load_weights('result/CsiNet_decoder_indoor_dim512_Step1_1_model.h5')
