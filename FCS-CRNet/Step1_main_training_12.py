...
file = 'CRNet_' + envir + '_dim' + str(encoded_dim) + 'Step1_12'
file_encoder = 'CRNet_encoder_' + envir + '_dim' + str(encoded_dim) + 'Step1_12'
file_decoder = 'CRNet_decoder_' + envir + '_dim' + str(encoded_dim) + 'Step1_12'
...
# load the weights of the FC layer
encoder_temp.load_weights('result/CRNet_encoder_indoor_dim512_Step1_1_model.h5')
...
print("Step1_main_training_12 has finished.")
