...
file = 'CRNet_' + envir + '_dim' + str(encoded_dim) + 'Step3'
...
encoder.load_weights('result/CRNet_encoder_outdoor_dim512_Step1_12_model.h5')

encoder.layers[18].trainable = False  # set the FC layer as untrainable

decoder.load_weights('result/CRNet_decoder_outdoor_dim512_Stemp1_12_model.h5')
