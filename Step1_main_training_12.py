...
encoder_temp = Model(image_tensor, encoder_network(image_tensor))
...
file = 'CsiNet_' + envir + '_dim' + str(encoded_dim) + 'Step1_12'
file_encoder = 'CsiNet_encoder_' + envir + '_dim' + str(encoded_dim) + 'Step1_12'
file_decoder = 'CsiNet_decoder_' + envir + '_dim' + str(encoded_dim) + 'Step1_12'
...
# set dense to outdoor weights
encoder_temp.load_weights('result/CsiNet_encoder_indoor_dim512_Step1_1_model.h5')
encoder.layers[5].set_weights(encoder_temp.layers[5].get_weights())
